...
#define SIMPLE 0
	...
	s.connect_ports("fo1", "out1", "br1", "in1"); // 3

	s.connect_ports("fo2", "out1", "con", "in1"); // 2
	s.connect_ports("br2", "out1", "fo2", "in1"); // 4

	s.connect_ports("br1", "out1", "fo2", "in2"); // 5

	s.connect_ports("gen", "out1", "fo1", "in1"); // 1
	s.connect_ports("fo1", "out2", "br2", "in1"); // 6
